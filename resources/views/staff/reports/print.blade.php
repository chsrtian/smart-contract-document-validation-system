...
<head>
    ...
    <style>
        ...
        .header { border-bottom: 2px solid #0f172a; padding-bottom: 10px; margin-bottom: 12px; display: flex; gap: 12px; align-items: center; }
        .header img { width: 72px; height: 72px; object-fit: contain; }
        .office-line-1 { font-size: 17px; font-weight: 700; }
        .office-line-2 { font-size: 15px; font-weight: 700; }
        .office-line-3 { font-size: 13px; color: #374151; }
        .report-title { margin-top: 4px; font-size: 19px; font-weight: 800; }
        .meta { margin-top: 2px; color: #374151; font-size: 12px; }
...
<body>
    <div class="toolbar">
        ...
        <a href="{{ route('staff.reports.index', $filters) }}">Back to Reports</a>
    </div>

    <div class="header">
        <img src="{{ $headerMeta['logo_url'] }}" alt="LCRO Magallanes Logo">
        <div>
